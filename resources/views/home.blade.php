...
<div class="row row-sm">
					...
					<div class="d-flex">
						<div class="">
							...
							<p class="mb-0 tx-12 text-white op-7">
								عدد الفواتير الغير مدفوعه {{\App\Models\invoices::where('Value_Status',2)->count()}}
							</p>
						</div>
						<span class="float-right my-auto mr-auto">
							...
							<span class="text-white op-7">
								...
								$count_unpaid = \App\Models\invoices::where('Value_Status', 2)->count();
								@endphp

								{{ $count_all > 0 ? round(($count_unpaid / $count_all) * 100) : 0 }}%
							</span>
						</span>
					</div>
				</div>
	...
	<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
		<div class="card overflow-hidden sales-card bg-warning-gradient">
			<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
				<div class="">
					<h6 class="mb-3 tx-12 text-white">الفواتير المدفوعه جزئيه</h6>
				</div>
				<div class="pb-0 mt-0">
					<div class="d-flex">
						<div class="">
						...
						<span class="float-right my-auto mr-auto">
							<i class="fas fa-arrow-circle-down text-white"></i>
							<span class="text-white op-7">
								{{round((\App\Models\invoices::where('Value_Status',3)->count() /
								\App\Models\invoices::count())*100)}}%
							</span>
						</span>
					</div>
