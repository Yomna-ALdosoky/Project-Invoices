            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        @can('اضافة منتج')
                        {{-- <a class="modal-effect btn btn-outline-primary btn-block" data-target="#exampleModal" data-toggle="modal" href="#modaldemo8">اضافه منتج</a> --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-outline-success btn-sm"
                                                data-name="{{ $x->product_name }}" data-pro_id="{{ $x->id }}"
